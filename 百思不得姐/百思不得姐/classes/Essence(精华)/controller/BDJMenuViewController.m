...
- (void)createMenu {
    ...
    BDJMenuView *menuView = [[BDJMenuView alloc] initWithIteme:self.subMenus rightIcon:self.rightImageName rightSelectIcon:self.rightHLImageName];
    //设置代理
...
//    NSInteger lastIndex = [self.ctrlArray indexOfObject:lastCtrl];
//    self.curPageIndex = lastIndex;
